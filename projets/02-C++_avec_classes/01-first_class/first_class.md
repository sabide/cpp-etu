# Introduction aux Classes en C++ (30mn)

**Objectif :** Cet exercice a pour objectif d’introduire les concepts fondamentaux des classes en C++ :   les différents types de constructeurs, la distinction entre attributs privés et publics, ainsi que l’usage des fonctions amies.   Pour illustrer ces notions, nous travaillerons dans le cadre de la géométrie en manipulant des points dans un plan cartésien.   Ce n’est peut-être pas l’exemple le plus enthousiasmant, mais il constitue une étape incontournable pour bien assimiler les bases. Il vous est demandé de suivre ce document pas à pas.
